...
public class DatabaseService {
	...
	/// Returns the vehicle identifier of the selected vehicle. If there is no vehicle selected then returns an empty string.
	public static var selectedFinOrVin: String {
