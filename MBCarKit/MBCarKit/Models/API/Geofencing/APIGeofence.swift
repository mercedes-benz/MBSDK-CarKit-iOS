...
public class APIGeofence: Decodable {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        if shapeInfo.contains(.circle) {
            ...
            let center = try shapeInfoValues.decodeIfPresent(APICoordinate.self, forKey: .center)
            ...
            let coordinates = shapeInfoValues.decodeArraySafelyIfPresent(APICoordinate.self, forKey: .coordinates)
