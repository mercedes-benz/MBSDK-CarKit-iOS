...
class WeeklyProfileModelTests: XCTestCase {
    ...
    func testAddTimeProfile() {
		...
		var weeklyProfileModel = MBCarKit.WeeklyProfileModel(
		...
		weeklyProfileModel = weeklyProfileModel.addTimeProfile(timeProfile: TimeProfile(hour: 1337, minute: 0, active: true, days: Set()))
    ...
    func testRemoveTimeProfile() {
        // This is an example of a functional test case.
        // Use XCTAssert and related functions to verify your tests produce the correct results.
		let weeklyProfileModel = MBCarKit.WeeklyProfileModel(
			singleEntriesActivatable: true,
			maxSlots: 0,
			maxTimeProfiles: 0,
			currentSlots: 0,
    ...
    func testAddRemoveMixTimeProfile() {
		...
		weeklyProfileModel = weeklyProfileModel.addTimeProfile(timeProfile: TimeProfile(identifier: 2, hour: 2, minute: 2, active: true, days: Set()))
		weeklyProfileModel = weeklyProfileModel.addTimeProfile(timeProfile: TimeProfile(identifier: 3, hour: 3, minute: 3, active: true, days: Set()))
